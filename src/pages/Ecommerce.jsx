...
import { Stacked, Pie, Button, Bar, SparkLine, LineChart } from "../components";
...
const Dropdown = ({ currentMode }) => (
  <div className="w-28 border-1 px-2 py-1 rounded-md">
    ...
    <div className='mt-12'>
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center '>
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className='text-2xl'>$68,448.78</p>
            </div>
          </div>
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
            ...
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  ...
                  <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 ml-3 text-ss'>23%</span>
                </p>
        ...
        <div>
          ...
          <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl w-400 p-8 m-3 flex justify-center items-center gap-10'>
            <div>
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
            ...
            {recentTransactions.map((item) => (
              <div key={item.title} className="flex justify-between mt-4">
                <div className='flex gap-4'>
                  ...
                  <div>
                    <p className="txt-md font-semibold">{item.title}</p>
        ...
        >
          ...
          <div className="md:w-full overfolow-auto">
            <LineChart />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          <div className="flex justify-between">
            ...
            <button type='buttom' className='text-xl font-semibold text-gray-400'>
              <IoIosMore />
            </button>
          </div>
